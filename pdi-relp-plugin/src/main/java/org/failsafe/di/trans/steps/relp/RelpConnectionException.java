...
public class RelpConnectionException extends Exception {
	/**
	* 
	*/
	private static final long serialVersionUID = 7227521502990425539L;

	/**
	 * Constructs a new throwable with null as its detail message.
	 */
	public RelpConnectionException() {
		super();
	}
	 ...
	 */
	public RelpConnectionException(String message) {
		super(message);
	}
	 ...
	 */
	public RelpConnectionException(Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public RelpConnectionException(String message, Throwable cause) {
		super(message, cause);
	}
